...
def all_in_one():
    ...
    # Plot 2: Scatter plot (Height vs Weight)
    ...
    axs[1, 1].set_title('Exponential Decay of Elements', fontsize='x-small')
    ...
    # Adjust layout and merge the last plot across two columns
    fig.delaxes(axs[2, 1])  # Remove the empty plot at the bottom right
    axs[2, 0].set_position([0.1, 0.05, 0.8, 0.25])  # Make the last plot span two columns
