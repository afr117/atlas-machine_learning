#!/usr/bin/env python3
"""
Transfer learning with MobileNetV2 on CIFAR-10 to achieve 87%+ validation accuracy.
"""
...
def preprocess_data(X, Y):
    """
    Normalize images and convert labels to one-hot encoded vectors.
    """
...
if __name__ == '__main__':
    ...
    early_stop = K.callbacks.EarlyStopping(monitor='val_accuracy', patience=3, restore_best_weights=True)
    reduce_lr = K.callbacks.ReduceLROnPlateau(monitor='val_loss', factor=0.5, patience=2, min_lr=1e-6)
