...
def train_model(network, data, labels, batch_size, epochs, validation_data=None,
    ...
    Args:
        ...
        validation_data (tuple, optional): Data to validate the model with. Defaults to None.
        early_stopping (bool, optional): Whether to apply early stopping. Defaults to False.
        patience (int, optional): Number of epochs to wait before stopping if no improvement. Defaults to 0.
        learning_rate_decay (bool, optional): Whether to use learning rate decay. Defaults to False.
        alpha (float, optional): Initial learning rate. Defaults to 0.1.
        decay_rate (float, optional): Decay rate for learning rate. Defaults to 1.
