...
def gensim_to_keras(model):
    ...
    Returns:
        keras.layers.Embedding: a trainable Embedding layer whose weights
        are initialized from the gensim model's word vectors.
        The weights can be further updated during Keras training.
    """
